...
Now connect your esp8266, open the .ino sketch under /esp8266/, select the appropriate port and board from the boards manager, and press the upload button. That is it, all interaction with these devices will be through the web application.
